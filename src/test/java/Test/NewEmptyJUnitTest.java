...
public class NewEmptyJUnitTest {
    ...
    public static HashMap<Integer, Persona> mapaAbuelo; //crear una mapa para personas 
    static Menu pp; //se llama a menu para poder hacer las pruebas de test
    /**
     * antes de hacer el test se llama a la clase menu 
     */
    @BeforeClass
    ...
    /**
     * metodo para quemar las personas del la estructurade arbol segun suparentesco
     * este metodo agrega a Abuelo y crea una mapa para debajo de el crear al padre
     * y debajo del padre crear otro mapa para agregar al hijo y dependiendo de ello 
     * es el tipo  de parentesco
     */
    ...
    /**
     * este metodo de test al abuelo haciendo la prueba de funcionalidad de los metodo de Menu();
     */
    @Test
    public void Abuelo(){
    ...
    /**
     * este metodo de test  al padre haciendo la prueba de funcionalidad de los metodo de Menu();
     */
    @Test
    public void Padre(){
        String respuesta1="";
    ...
    /**
     * este metodo de test  al hijo haciendo la prueba de funcionalidad de los metodo de Menu();
     */
    @Test
    public void Hijo(){
        String respuesta2 = "";
